...
public class SubcategoryAdapter extends RecyclerView.Adapter<SubcategoryAdapter.ViewHolder> {
    ...
    public SubcategoryAdapter(List<FetchedListOfSubcategory> listOfSubcategories, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final FetchedListOfSubcategory listItem = listOfSubcategories.get(position);

        holder.itemName.setText(listItem.getSubcategory_name());
